...
richter[["HTO"]]@counts
```
The problem seems to be with the hashing of sample ICGC-3299-19-2768B, which contains no UMI. Hence, we will need to repeat the experiment for this particular sample. Nevertheless, we can proceed with the remaining ones.
